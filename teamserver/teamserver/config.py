...
CELERY_BROKER_TRANSPORT = {"region": "us-west-2"}
...
COLLECTION_TARGET_CREDS = "target_creds"
...
LOG_LEVELS = {"DEBUG": 0, "INFO": 1, "WARN": 2, "CRIT": 3, "FATAL": 4}
...
SESSION_STATUSES = {"active": "active", "missing": "missing", "inactive": "inactive"}
