...
class Session(Document):
    ...
    def config(self):
        ...
        self.config_dict[
            "interval"
        ] = self.interval  # pylint: disable=unsupported-assignment-operation
        self.config_dict[
            "interval_delta"
        ] = self.interval_delta  # pylint: disable=unsupported-assignment-operation
        self.config_dict[
            "servers"
        ] = self.servers  # pylint: disable=unsupported-assignment-operation
