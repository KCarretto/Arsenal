...
try:
    from testutils.test_cases import ModelTest #pylint: disable=no-name-in-module
except ModuleNotFoundError:
    from os.path import abspath, dirname
    sys.path.append(abspath(dirname(dirname(dirname(abspath(__file__))))))
    from tests.testutils.test_cases import ModelTest #pylint: disable=no-name-in-module
